...
class DataBaseService {
  ...
  Future<void> CreateUser(
      String _uid, String _email, String _name, String imageurl) async {
    try {
  ...
  Future<void> updateUserLastTimeSeen(String _uid) async {
    try {
      await _db.collection(USER_COLLECTION).doc(_uid).update({
        "last_activity": DateTime.now().toUtc(),
        "last_active":DateTime.now().toUtc(),
      });
    } catch (e) {
      print(e);
  ...
  Future<DocumentReference?> createChat(Map<String,dynamic> _data)
  async{
